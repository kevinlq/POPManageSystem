...
void frmMessageBox::SetMessage(const QString &msg, int type)
{
    ...
    if (type == 0)
    {
        ui->labIcoMain->setStyleSheet("border-image: url(:/image/message/info.png);");
    ...
    {
        ui->labIcoMain->setStyleSheet("border-image: url(:/image/message/question.png);");
        ui->lab_Title->setText("询问");
    }
    //错误消息框
    else if (type == 2)
    {
        ui->labIcoMain->setStyleSheet("border-image: url(:/image/message/error.png);");
